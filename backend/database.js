...
const readTeacherInfo = async (name, age, id) => {
...
const deleteTeacher = async (name, age, id) => {
...
const readStudentInfo = async (id, name, age, religion) => {
...
const deleteStudent = async (id, name, age, religion) => {
